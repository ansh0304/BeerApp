...
/// }
/// 
class SLReachability {
    
    typealias ReachabilityHandler = (SLReachability) -> Void
    ...
    fileprivate let reachabilityQueue = DispatchQueue(label: "com.sonyliv.reachability")
...
func callback(reachability: SCNetworkReachability, flags: SCNetworkReachabilityFlags, info: UnsafeMutableRawPointer?) {
    ...
    let reachability = Unmanaged<SLReachability>.fromOpaque(info).takeUnretainedValue()
...
extension SLReachability {
    ...
    func startNotifier() {
        ...
        context.info = UnsafeMutableRawPointer(Unmanaged<SLReachability>.passUnretained(self).toOpaque())
